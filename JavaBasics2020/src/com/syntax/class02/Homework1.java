...
public class Homework1 {
	...
	/*
	 * 8 primitive Data Types (byte, short, int, loang, float, double, char,
	 * boolean) I want you to print each variable on a separate line and test it's
	...
	public static void main(String[] args) {
	    ...
	    //variable declaration and assign in 1 step
		                      int ummarZahid2 = 2359;
		                      
		 long tatiana = 2234685678666666698L;
		 double raman = 3.4;
		 float olga = 7.9863f;
		 ...
		 int murod1=3, murod2=70, murod3=89;
		 
		 System.out.println(murod1);
		 System.out.println(murod2 + murod3);
